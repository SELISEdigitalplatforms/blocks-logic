      ...
      proxy: proxyTarget
        ? {
            "/api": { 
              ...
              changeOrigin: true, 
              secure: false,
              cookieDomainRewrite: "dev-cloud.seliseblocks.com",
            },
            "/idp": { 
              target: proxyTarget, 
              changeOrigin: true, 
            ...
            "/communication": { target: proxyTarget, changeOrigin: true, secure: false },
            "/cloudconfiguration": { target: proxyTarget, changeOrigin: true, secure: false },
            "/uilm": { target: proxyTarget, changeOrigin: true, secure: false },
            "/utilities": { target: proxyTarget, changeOrigin: true, secure: false },
            "/cloudbuild": { target: proxyTarget, changeOrigin: true, secure: false },
