...
const services: Service[] = [
	{
		...
		url: "https://agents.seliseblocks.com",
	...
	},
	{
		...
		url: "https://deployment.seliseblocks.com",
	...
	},
	{
		...
		url: "https://data.seliseblocks.com",
			...
			<main className="relative z-10 flex flex-1 flex-col items-start justify-center gap-16 px-6 py-12 lg:flex-row lg:items-center lg:gap-16 lg:py-0 xl:px-[154px]">
				<div className="flex flex-1 flex-col items-start gap-6">
					...
					<p className="max-w-lg text-lg leading-relaxed tracking-tight text-muted-foreground">
						Blocks OS is a modern platform for building and
						deploying secure, scalable applications with built-in
						observability, AI capabilities, and comprehensive
						identity management. Focus on your application logic
