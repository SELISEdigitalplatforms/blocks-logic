...
const API_SETTINGS_SUBPATH = "/ApiSettings";

export const API_SETTINGS_ENDPOINTS = {
  GETS: `${API_BASES.CLOUD_CONFIGURATION}${API_SETTINGS_SUBPATH}/Gets`,
  UPDATE: `${API_BASES.CLOUD_CONFIGURATION}${API_SETTINGS_SUBPATH}/Update`,
  BULK_UPDATE: `${API_BASES.CLOUD_CONFIGURATION}${API_SETTINGS_SUBPATH}/BulkUpdate`,
  REMOVE: `${API_BASES.CLOUD_CONFIGURATION}${API_SETTINGS_SUBPATH}/Remove`,
} as const;
