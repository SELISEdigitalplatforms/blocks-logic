...
import { ChevronDown, Lock, Shield, Users, Smartphone, HardDrive, Mail, Settings } from "lucide-react";
        ...
        <div className="flex items-center gap-3 px-4 py-3">
          ...
          <CollapsibleTrigger asChild>
            <button className="flex flex-1 items-center gap-3 text-left">
              <div className="text-muted-foreground">{iconMap[meta.icon]}</div>
          ...
          <div className="flex shrink-0 items-center gap-2">
            ...
            <SecurityPresetsPopover
              ...
              onDisableAll={() => {
                onBulkGroupMfa(groupIds, false);
                onBulkGroupCaptcha(groupIds, false);
              }}
            />
            <CollapsibleTrigger asChild>
