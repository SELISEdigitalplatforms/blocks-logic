...
export const NodeDefinitions: WorkflowNodeDefinition[] = [
  ...
  },
  {
    ...
    title: "Data Trigger",
    description: "Triggers the workflow when data is inserted, updated, or deleted in a collection",
    type: "dataGateway",
    category: "trigger",
    version: "v1",
  ...
  },
  {
    ...
    title: "Data Action",
    description: "Perform CRUD operations (Get, Insert, Update, Delete) on data collections.",
    category: "action",
    type: "dataAction",
    version: "v1",
  ...
  },
  {
    ...
    title: "If",
    description: "Branch the workflow based on a condition (true/false outputs).",
    type: "if",
    category: "logic",
    version: "v1",
    defaultName: "If",
...
export const getNodeDefinition = (category: string, type: string, version: string) => {
  return NodeDefinitions.find(
    (def) => def.category === category && def.type === type && def.version === version,
  );
};
