...
namespace Cloud.DomainService.Repositories
{
    public interface IApiEndpointConfigRepository
    {
        ...
        Task<bool> UpdateAsync(string tenantId,string itemId, bool isCaptchaRequired, bool isMfaRequired, string updatedBy);
        Task<long> BulkUpdateAsync(string tenantId, List<string> itemIds, bool isCaptchaRequired, bool isMfaRequired, string updatedBy);
    }
}
