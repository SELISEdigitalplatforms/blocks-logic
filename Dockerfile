...
# =============================================================================
# Blocks Logic API: production image (Kestrel + static React from wwwroot)
# Build: docker build -t blocks-logic-api .
# =============================================================================
...
LABEL org.opencontainers.image.title="blocks-logic-api" \
    org.opencontainers.image.description="ASP.NET Core Blocks Logic API; React SPA served from wwwroot." \
